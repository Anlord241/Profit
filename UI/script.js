...
(function () {
  ...
  let adCollection = new AdCollection(ads);
  console.log('Created collection:');
  console.log(adCollection.advertisements);

  console.log(adCollection.size());
  ...
  console.log(adCollection.get('20'));
  //////////////////////////////////////
  console.log("Trying to remove an ad which doesn't exist:");
  console.log(adCollection.remove('0'));
